...
;777
			...
			CALL SET2 ;_DONE GENERATE NUMBER FOR ONE EXAMPLE
...
17$:		RET
START:    	CALL WELC4
		    CALL INFO1 ;вывод на экран количество отсвшихся попыток
			RET
...
26$:	   CMP (R5)+,R4     ;COMPARE R5-R0
	       ...
	       DEC R5		 ;TODO? тут только двух значные цифры
...
INPUTSCR:  MOV #NUMB10ADR,R2;вывод на экран числа попыток
29$:	   MOV (R2)+,R0
